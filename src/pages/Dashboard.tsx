          ...
          {activeTab === 'overview' && (
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border-4 border-primary-600 dark:border-accent-600 p-6">
                <h2 
                  className="text-xl font-semibold text-gray-900 dark:text-accent-400 mb-4" 
                  tabIndex={-1}
                >
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border-4 border-primary-600 dark:border-accent-600 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  ...
                  >
                    <FileText className="w-8 h-8 text-primary-600 dark:text-accent-400 mb-3 group-hover:scale-110 transition-transform" />
                  ...
                  <div className="group p-6 bg-gray-50 dark:bg-gray-700 rounded-lg border-4 border-primary-600 dark:border-accent-600">
                    <FileText className="w-8 h-8 text-primary-600 dark:text-accent-400 mb-3" />
                    ...
                    {recentDocument ? (
                      <div>
                        ...
                        <a
                          ...
                          className="inline-flex items-center gap-1 text-sm text-primary-600 dark:text-accent-400 hover:text-primary-700 dark:hover:text-accent-300 transition-colors"
                        >
                  ...
                  <button
                    ...
                    className="group p-6 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg border-4 border-primary-600 dark:border-accent-600 hover:border-primary-500 dark:hover:border-accent-500 transition-all duration-300 hover:-translate-y-1 text-left min-h-[44px]"
                  >
                    <Calendar className="w-8 h-8 text-primary-600 dark:text-accent-400 mb-3 group-hover:scale-110 transition-transform" />
                    ...
                    <div className="space-y-4">
                      {activities.slice(0, 5).map((activity) => (
                        <div key={activity.id} className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                          <div className="w-2 h-2 bg-primary-600 dark:bg-accent-600 rounded-full mt-2"></div>
                          ...
                          <td className="py-3 px-4">
                            <div className="flex gap-2">
                              <button
                                ...
                                className="p-2 text-gray-600 hover:text-primary-600 dark:text-gray-400 dark:hover:text-accent-400 min-h-[44px] min-w-[44px] flex items-center justify-center"
                                title="View"
                              >
