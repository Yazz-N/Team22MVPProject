        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit, index) => {
            ...
            return (
              <div 
                key={index}
                className="group p-8 bg-white dark:bg-primary-800 rounded-xl border border-secondary-200 dark:border-primary-600 hover:border-secondary-300 dark:hover:border-primary-500 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              >
                ...
                <h3 className="text-xl font-semibold text-primary-800 dark:text-white mb-3">{benefit.title}</h3>
                <p className="text-primary-700 dark:text-secondary-400 leading-relaxed">{benefit.description}</p>
              </div>
            );
          })}
        </div>
