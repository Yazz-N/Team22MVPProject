          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-secondary-800 dark:text-white mb-3">{benefit.title}</h3>
                <p className="text-secondary-700 dark:text-secondary-400 leading-relaxed">{benefit.description}</p>
              </div>
            );
          })}
        </div>
