...
const Benefits = () => {
  ...
  return (
    <section id="benefits" className="py-20 bg-white dark:bg-secondary-900">
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-secondary-900 dark:text-white mb-3">{benefit.title}</h3>
                <p className="text-secondary-600 dark:text-secondary-400 leading-relaxed">{benefit.description}</p>
              </div>
            );
          })}
        </div>
