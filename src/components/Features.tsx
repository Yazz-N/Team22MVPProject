...
const Features = () => {
  ...
  return (
    <section id="features" className="py-20 bg-secondary-50/50 dark:bg-secondary-800">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-secondary-700 dark:text-secondary-400 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <div className="inline-flex p-3 rounded-lg bg-gradient-to-br from-primary-100 to-secondary-100 dark:from-primary-900/50 dark:to-secondary-900/50 mb-4 group-hover:scale-110 transition-transform duration-300">
                ...
                <h3 className="text-xl font-semibold text-secondary-800 dark:text-white mb-3">{feature.title}</h3>
                <p className="text-secondary-700 dark:text-secondary-400 leading-relaxed">{feature.description}</p>
              </div>
            );
          })}
        </div>
