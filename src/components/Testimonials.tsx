...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-20 bg-gradient-to-br from-secondary-50 to-accent-50/30 dark:from-primary-800 dark:to-secondary-900/30">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-primary-800 dark:text-white mb-4">
            What Our Clients Say
          </h2>
          <p className="text-lg text-primary-700 dark:text-secondary-400">
            Discover how teams worldwide are transforming their operations with Workflow Mach 3.
          </p>
        </div>

        <div className="relative">
          <div className="bg-white dark:bg-primary-700 rounded-2xl p-8 md:p-12 shadow-lg border border-secondary-100 dark:border-primary-600 min-h-[300px] flex items-center">
            <div className="w-full text-center">
              ...
              {/* Review Text */}
              <blockquote className="text-xl md:text-2xl text-primary-800 dark:text-secondary-300 italic mb-8 leading-relaxed">
              ...
              <div className="flex items-center justify-center gap-4">
                <img 
                  ...
                  className="w-16 h-16 rounded-full object-cover border-2 border-secondary-200 dark:border-primary-600"
                />
                <div className="text-left">
                  <div className="font-semibold text-primary-800 dark:text-white text-lg">
                    {testimonials[currentIndex].name}
                  </div>
                  <div className="text-primary-700 dark:text-secondary-400">
                    {testimonials[currentIndex].title}
                  </div>
                  <div className="text-primary-600 dark:text-secondary-500 text-sm">
          ...
          <button 
            ...
            className="absolute left-4 top-1/2 transform -translate-y-1/2 p-3 bg-white dark:bg-primary-700 hover:bg-secondary-50 dark:hover:bg-primary-600 rounded-full shadow-lg border border-secondary-200 dark:border-primary-600 transition-all duration-200 hover:scale-110"
          >
            <ChevronLeft className="w-5 h-5 text-secondary-600 dark:text-secondary-400" />
          </button>
          <button 
            onClick={nextTestimonial}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 p-3 bg-white dark:bg-primary-700 hover:bg-secondary-50 dark:hover:bg-primary-600 rounded-full shadow-lg border border-secondary-200 dark:border-primary-600 transition-all duration-200 hover:scale-110"
          >
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-200 ${
                  index === currentIndex 
                    ? 'bg-secondary-600 dark:bg-secondary-400 scale-110' 
                    : 'bg-secondary-300 dark:bg-primary-600 hover:bg-secondary-400 dark:hover:bg-primary-500'
                }`}
              />
            ))}
          </div>
