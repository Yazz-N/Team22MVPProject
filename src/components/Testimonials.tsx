...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-20 bg-gradient-to-br from-secondary-50 to-primary-50/30 dark:from-secondary-800 dark:to-primary-900/30">
        ...
        <div className="relative">
          <div className="bg-white dark:bg-secondary-700 rounded-2xl p-8 md:p-12 shadow-lg border border-secondary-100 dark:border-secondary-600 min-h-[300px] flex items-center">
            <div className="w-full text-center">
              ...
              {/* Review Text */}
              <blockquote className="text-xl md:text-2xl text-secondary-700 dark:text-secondary-300 italic mb-8 leading-relaxed">
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="text-left">
                  <div className="font-semibold text-secondary-900 dark:text-white text-lg">
                    {testimonials[currentIndex].name}
                  </div>
                  <div className="text-secondary-600 dark:text-secondary-400">
                    {testimonials[currentIndex].title}
                  </div>
                  <div className="text-secondary-500 dark:text-secondary-500 text-sm">
          ...
          <button 
            ...
            className="absolute left-4 top-1/2 transform -translate-y-1/2 p-3 bg-white dark:bg-secondary-700 hover:bg-secondary-50 dark:hover:bg-secondary-600 rounded-full shadow-lg border border-secondary-200 dark:border-secondary-600 transition-all duration-200 hover:scale-110"
          >
            <ChevronLeft className="w-5 h-5 text-secondary-600 dark:text-secondary-400" />
          </button>
          <button 
            onClick={nextTestimonial}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 p-3 bg-white dark:bg-secondary-700 hover:bg-secondary-50 dark:hover:bg-secondary-600 rounded-full shadow-lg border border-secondary-200 dark:border-secondary-600 transition-all duration-200 hover:scale-110"
          >
