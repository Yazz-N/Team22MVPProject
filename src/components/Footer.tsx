  ...
  return (
    <footer className="bg-secondary-900 dark:bg-secondary-900 text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        {/* CTA Section */}
        <div className="text-center mb-16 pb-16 border-b border-secondary-700">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 bg-secondary-800 hover:bg-primary-600 rounded-lg transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              <li><a href="#features" className="text-primary-200 hover:text-primary-100 transition-colors">Features</a></li>
              <li><a href="#benefits" className="text-primary-200 hover:text-primary-100 transition-colors">Benefits</a></li>
              <li><a href="#testimonials" className="text-primary-200 hover:text-primary-100 transition-colors">Testimonials</a></li>
              <li><a href="#faq" className="text-primary-200 hover:text-primary-100 transition-colors">FAQ</a></li>
              <li><a href="#" className="text-primary-200 hover:text-primary-100 transition-colors">Documentation</a></li>
              <li><a href="#" className="text-primary-200 hover:text-primary-100 transition-colors">Support</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:hello@workflowmach3.com" className="text-primary-200 hover:text-primary-100 transition-colors break-all">
                  hello@workflowmach3.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-primary-200" />
                <span className="text-primary-200">+44 20 7123 4567</span>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-primary-200 mt-0.5" />
                <span className="text-primary-200">London, United Kingdom</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-secondary-700 pt-8 mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              <a href="#" className="text-primary-200 hover:text-primary-100 transition-colors">Privacy Policy</a>
              <a href="#" className="text-primary-200 hover:text-primary-100 transition-colors">Terms & Conditions</a>
              <a href="#" className="text-primary-200 hover:text-primary-100 transition-colors">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
