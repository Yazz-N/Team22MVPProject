  ...
  return (
    <footer className="bg-primary-900 dark:bg-black text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        {/* CTA Section */}
        <div className="text-center mb-16 pb-16 border-b border-primary-800 dark:border-primary-700">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <div className="p-2 bg-gradient-to-r from-secondary-600 to-accent-600 rounded-lg">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 bg-primary-800 dark:bg-primary-800 hover:bg-primary-700 dark:hover:bg-primary-600 rounded-lg transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><a href="#benefits" className="text-secondary-300 hover:text-white transition-colors">Benefits</a></li>
              <li><a href="#testimonials" className="text-secondary-300 hover:text-white transition-colors">Testimonials</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:hello@workflowmach3.com" className="text-secondary-300 hover:text-white transition-colors break-all">
                  hello@workflowmach3.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-secondary-300" />
                <span className="text-secondary-300">+44 20 7123 4567</span>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-secondary-300 mt-0.5" />
                <span className="text-secondary-300">London, United Kingdom</span>
              </li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-primary-800 dark:border-primary-700 pt-8 mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-secondary-300 text-sm">
              © 2025 Workflow Mach 3. All rights reserved.
            </p>
            <div className="flex gap-6 text-sm">
              <a href="#" className="text-secondary-300 hover:text-white transition-colors">Privacy Policy</a>
              <a href="#" className="text-secondary-300 hover:text-white transition-colors">Terms & Conditions</a>
              <a href="#" className="text-secondary-300 hover:text-white transition-colors">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
