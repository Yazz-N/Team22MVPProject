        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm font-semibold mb-4 text-primary-400">Quick Links</h3>
            <ul className="space-y-2 text-xs">
              ...
              <li><a href="#testimonials" className="text-gray-300 hover:text-primary-400 transition-colors">Testimonials</a></li>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-sm font-semibold mb-4 text-primary-400">Contact</h3>
        ...
        <div className="border-t border-gray-700 pt-8 mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              ...
              <a href="#" className="text-gray-300 hover:text-primary-400 transition-colors">Terms & Conditions</a>
