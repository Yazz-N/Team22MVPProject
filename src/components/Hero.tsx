...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-secondary-50 via-primary-50 to-accent-50 dark:from-secondary-900 dark:via-secondary-800 dark:to-secondary-900">
      {/* Abstract Background - Hero Section Only */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Flowing Gradient Shapes */}
        <div className="absolute top-20 -left-20 w-96 h-96 bg-gradient-to-r from-primary-400/30 to-accent-400/30 dark:from-primary-600/20 dark:to-accent-600/20 rounded-full blur-3xl animate-pulse"></div>
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-primary-300/20 to-accent-300/20 dark:from-primary-500/15 dark:to-accent-500/15 rounded-full blur-2xl animate-pulse delay-500"></div>
        ...
        <svg className="absolute inset-0 w-full h-full opacity-20 dark:opacity-10" xmlns="http://www.w3.org/2000/svg">
          ...
          <circle cx="200" cy="150" r="3" fill="#2563eb" opacity="0.6" />
          <circle cx="400" cy="250" r="2" fill="#f97316" opacity="0.6" />
          <circle cx="600" cy="180" r="2.5" fill="#71717a" opacity="0.6" />
        </svg>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-xl md:text-2xl text-secondary-700 dark:text-secondary-300 mb-4 max-w-4xl mx-auto leading-relaxed">
          A centralised hub that transforms how product managers handle internal workflows, 
          SOP management, and real-time updates
        </p>
        
        <p className="text-lg text-secondary-600 dark:text-secondary-400 mb-12 max-w-3xl mx-auto">
