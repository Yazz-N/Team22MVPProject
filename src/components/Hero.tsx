  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary-50 via-secondary-50 to-accent-50 dark:from-secondary-900 dark:via-primary-900 dark:to-accent-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 -left-20 w-96 h-96 bg-gradient-to-r from-secondary-400/30 to-primary-400/30 dark:from-secondary-600/20 dark:to-primary-600/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 -right-20 w-80 h-80 bg-gradient-to-r from-accent-400/30 to-secondary-400/30 dark:from-accent-600/20 dark:to-secondary-600/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-secondary-300/20 to-primary-300/20 dark:from-secondary-500/15 dark:to-primary-500/15 rounded-full blur-2xl animate-pulse delay-500"></div>
